...
/**
 * \ingroup split3
 * \brief Less trivial test of SPLIT3 Topology Control message generation
 *
 * This test simulates 3 Wi-Fi stations with chain topology and runs SPLIT3 without any extra traffic.
