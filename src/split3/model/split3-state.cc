...
MprSelectorTuple*
Split3State::FindMprSelectorTuple (Ipv4Address const &mainAddr)
{
...
void
Split3State::EraseMprSelectorTuple (const MprSelectorTuple &tuple)
{
  for (MprSelectorSet::iterator it = m_mprSelectorSet.begin ();
       it != m_mprSelectorSet.end (); it++)
    {
...
void
Split3State::EraseMprSelectorTuples (const Ipv4Address &mainAddr)
{
  for (MprSelectorSet::iterator it = m_mprSelectorSet.begin ();
...
void
Split3State::InsertMprSelectorTuple (MprSelectorTuple const &tuple)
{
  m_mprSelectorSet.push_back (tuple);
}

std::string
Split3State::PrintMprSelectorSet () const
{
...
NeighborTuple*
Split3State::FindNeighborTuple (Ipv4Address const &mainAddr)
{
...
const NeighborTuple*
Split3State::FindSymNeighborTuple (Ipv4Address const &mainAddr) const
{
...
NeighborTuple*
Split3State::FindNeighborTuple (Ipv4Address const &mainAddr, uint8_t willingness)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
void
Split3State::EraseNeighborTuple (const NeighborTuple &tuple)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
void
Split3State::EraseNeighborTuple (const Ipv4Address &mainAddr)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
void
Split3State::InsertNeighborTuple (NeighborTuple const &tuple)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
TwoHopNeighborTuple*
Split3State::FindTwoHopNeighborTuple (Ipv4Address const &neighborMainAddr,
...
void
Split3State::EraseTwoHopNeighborTuple (const TwoHopNeighborTuple &tuple)
{
  for (TwoHopNeighborSet::iterator it = m_twoHopNeighborSet.begin ();
       it != m_twoHopNeighborSet.end (); it++)
    {
...
void
Split3State::EraseTwoHopNeighborTuples (const Ipv4Address &neighborMainAddr,
...
void
Split3State::InsertTwoHopNeighborTuple (TwoHopNeighborTuple const &tuple)
{
...
bool
Split3State::FindMprAddress (Ipv4Address const &addr)
{
...
void
Split3State::SetMprSet (MprSet mprSet)
{
  m_mprSet = mprSet;
}
MprSet
Split3State::GetMprSet () const
{
  return m_mprSet;
}
...
DuplicateTuple*
Split3State::FindDuplicateTuple (Ipv4Address const &addr, uint16_t sequenceNumber)
{
...
void
Split3State::EraseDuplicateTuple (const DuplicateTuple &tuple)
{
  for (DuplicateSet::iterator it = m_duplicateSet.begin ();
       it != m_duplicateSet.end (); it++)
    {
...
void
Split3State::InsertDuplicateTuple (DuplicateTuple const &tuple)
{
...
LinkTuple*
Split3State::FindLinkTuple (Ipv4Address const & ifaceAddr)
{
...
LinkTuple*
Split3State::FindSymLinkTuple (Ipv4Address const &ifaceAddr, Time now)
{
  for (LinkSet::iterator it = m_linkSet.begin ();
       it != m_linkSet.end (); it++)
    {
...
void
Split3State::EraseLinkTuple (const LinkTuple &tuple)
{
  for (LinkSet::iterator it = m_linkSet.begin ();
       it != m_linkSet.end (); it++)
    {
...
LinkTuple&
Split3State::InsertLinkTuple (LinkTuple const &tuple)
{
...
TopologyTuple*
Split3State::FindTopologyTuple (Ipv4Address const &destAddr,
...
TopologyTuple*
Split3State::FindNewerTopologyTuple (Ipv4Address const & lastAddr, uint16_t ansn)
{
  for (TopologySet::iterator it = m_topologySet.begin ();
       it != m_topologySet.end (); it++)
    {
...
void
Split3State::EraseTopologyTuple (const TopologyTuple &tuple)
{
  for (TopologySet::iterator it = m_topologySet.begin ();
       it != m_topologySet.end (); it++)
    {
...
void
Split3State::EraseOlderTopologyTuples (const Ipv4Address &lastAddr, uint16_t ansn)
{
  for (TopologySet::iterator it = m_topologySet.begin ();
...
void
Split3State::InsertTopologyTuple (TopologyTuple const &tuple)
{
...
IfaceAssocTuple*
Split3State::FindIfaceAssocTuple (Ipv4Address const &ifaceAddr)
{
...
Split3State::FindIfaceAssocTuple (Ipv4Address const &ifaceAddr) const
{
...
void
Split3State::EraseIfaceAssocTuple (const IfaceAssocTuple &tuple)
{
  for (IfaceAssocSet::iterator it = m_ifaceAssocSet.begin ();
       it != m_ifaceAssocSet.end (); it++)
    {
...
void
Split3State::InsertIfaceAssocTuple (const IfaceAssocTuple &tuple)
{
  m_ifaceAssocSet.push_back (tuple);
}

std::vector<Ipv4Address>
Split3State::FindNeighborInterfaces (const Ipv4Address &neighborMainAddr) const
{
...
AssociationTuple*
Split3State::FindAssociationTuple (const Ipv4Address &gatewayAddr, const Ipv4Address &networkAddr, const Ipv4Mask &netmask)
{
...
void
Split3State::EraseAssociationTuple (const AssociationTuple &tuple)
{
  for (AssociationSet::iterator it = m_associationSet.begin ();
       it != m_associationSet.end (); it++)
    {
...
void
Split3State::InsertAssociationTuple (const AssociationTuple &tuple)
{
  m_associationSet.push_back (tuple);
}

void
Split3State::EraseAssociation (const Association &tuple)
{
...
void
Split3State::InsertAssociation (const Association &tuple)
{
  m_associations.push_back (tuple);
}

}
}  // namespace split3, ns3
