...
/// \brief	This header file declares and defines internal state of an SPLIT3 node.

#ifndef SPLIT3_STATE_H
#define SPLIT3_STATE_H
...
/// \ingroup split3
/// This class encapsulates all data structures needed for maintaining internal state of an SPLIT3 node.
class Split3State
{
  //  friend class Split3;
