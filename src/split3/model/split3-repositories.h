...
///
/// \brief Here are defined all data structures needed by an SPLIT3 node.
///

#ifndef SPLIT3_REPOSITORIES_H
#define SPLIT3_REPOSITORIES_H
...
}  // namespace ns3, split3

#endif /* SPLIT3_REPOSITORIES_H */
