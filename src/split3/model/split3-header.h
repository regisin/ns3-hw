...
#ifndef SPLIT3_HEADER_H
#define SPLIT3_HEADER_H
 ...
 * \ingroup split3
 *
 * The basic layout of any packet in SPLIT3 is as follows (omitting IP and
 * UDP headers):
  \verbatim
    0                   1                   2                   3
