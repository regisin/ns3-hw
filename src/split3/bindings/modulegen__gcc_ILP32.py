...
def module_init():
    root_module = Module('ns.split3', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## split3-helper.h (module 'split3'): ns3::Split3Helper [class]
    module.add_class('Split3Helper', parent=root_module['ns3::Ipv4RoutingHelper'])
    ...
    ## Register a nested module for the namespace split3
    
    nested_module = module.add_cpp_namespace('split3')
    register_types_ns3_split3(nested_module)
...
def register_types_ns3_split3(module):
    root_module = module.get_root()
    
    ## split3-repositories.h (module 'split3'): ns3::split3::Association [struct]
    module.add_class('Association')
    ## split3-repositories.h (module 'split3'): ns3::split3::AssociationTuple [struct]
    module.add_class('AssociationTuple')
    ## split3-repositories.h (module 'split3'): ns3::split3::DuplicateTuple [struct]
    module.add_class('DuplicateTuple')
    ## split3-repositories.h (module 'split3'): ns3::split3::IfaceAssocTuple [struct]
    module.add_class('IfaceAssocTuple')
    ## split3-repositories.h (module 'split3'): ns3::split3::LinkTuple [struct]
    module.add_class('LinkTuple')
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader [class]
    module.add_class('MessageHeader', parent=root_module['ns3::Header'])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::MessageType [enumeration]
    module.add_enum('MessageType', ['HELLO_MESSAGE', 'TC_MESSAGE', 'MID_MESSAGE', 'HNA_MESSAGE'], outer_class=root_module['ns3::split3::MessageHeader'])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hello [struct]
    module.add_class('Hello', outer_class=root_module['ns3::split3::MessageHeader'])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hello::LinkMessage [struct]
    module.add_class('LinkMessage', outer_class=root_module['ns3::split3::MessageHeader::Hello'])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hna [struct]
    module.add_class('Hna', outer_class=root_module['ns3::split3::MessageHeader'])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hna::Association [struct]
    module.add_class('Association', outer_class=root_module['ns3::split3::MessageHeader::Hna'])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Mid [struct]
    module.add_class('Mid', outer_class=root_module['ns3::split3::MessageHeader'])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Tc [struct]
    module.add_class('Tc', outer_class=root_module['ns3::split3::MessageHeader'])
    ## split3-repositories.h (module 'split3'): ns3::split3::MprSelectorTuple [struct]
    module.add_class('MprSelectorTuple')
    ## split3-repositories.h (module 'split3'): ns3::split3::NeighborTuple [struct]
    module.add_class('NeighborTuple')
    ## split3-repositories.h (module 'split3'): ns3::split3::NeighborTuple::Status [enumeration]
    module.add_enum('Status', ['STATUS_NOT_SYM', 'STATUS_SYM'], outer_class=root_module['ns3::split3::NeighborTuple'])
    ## split3-state.h (module 'split3'): ns3::split3::Split3State [class]
    module.add_class('Split3State')
    ## split3-header.h (module 'split3'): ns3::split3::PacketHeader [class]
    module.add_class('PacketHeader', parent=root_module['ns3::Header'])
    ## split3-routing-protocol.h (module 'split3'): ns3::split3::RoutingProtocol [class]
    module.add_class('RoutingProtocol', parent=root_module['ns3::Ipv4RoutingProtocol'])
    ## split3-routing-protocol.h (module 'split3'): ns3::split3::RoutingTableEntry [struct]
    module.add_class('RoutingTableEntry')
    ## split3-repositories.h (module 'split3'): ns3::split3::TopologyTuple [struct]
    module.add_class('TopologyTuple')
    ## split3-repositories.h (module 'split3'): ns3::split3::TwoHopNeighborTuple [struct]
    ...
    module.add_container('std::vector< ns3::split3::MessageHeader::Hello::LinkMessage >', 'ns3::split3::MessageHeader::Hello::LinkMessage', container_type=u'vector')
    module.add_container('std::vector< ns3::split3::MessageHeader::Hna::Association >', 'ns3::split3::MessageHeader::Hna::Association', container_type=u'vector')
    module.add_container('std::vector< ns3::split3::MprSelectorTuple >', 'ns3::split3::MprSelectorTuple', container_type=u'vector')
    module.add_container('std::vector< ns3::split3::NeighborTuple >', 'ns3::split3::NeighborTuple', container_type=u'vector')
    module.add_container('std::vector< ns3::split3::TwoHopNeighborTuple >', 'ns3::split3::TwoHopNeighborTuple', container_type=u'vector')
    module.add_container('ns3::split3::MprSet', 'ns3::Ipv4Address', container_type=u'set')
    module.add_container('std::vector< ns3::split3::LinkTuple >', 'ns3::split3::LinkTuple', container_type=u'vector')
    module.add_container('std::vector< ns3::split3::TopologyTuple >', 'ns3::split3::TopologyTuple', container_type=u'vector')
    module.add_container('std::vector< ns3::split3::IfaceAssocTuple >', 'ns3::split3::IfaceAssocTuple', container_type=u'vector')
    module.add_container('std::vector< ns3::split3::AssociationTuple >', 'ns3::split3::AssociationTuple', container_type=u'vector')
    module.add_container('std::vector< ns3::split3::Association >', 'ns3::split3::Association', container_type=u'vector')
    module.add_container('std::vector< ns3::split3::RoutingTableEntry >', 'ns3::split3::RoutingTableEntry', container_type=u'vector')
    module.add_container('std::set< unsigned int >', 'unsigned int', container_type=u'set')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::DuplicateTuple, std::allocator< ns3::split3::DuplicateTuple > >', u'ns3::split3::DuplicateSet')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::DuplicateTuple, std::allocator< ns3::split3::DuplicateTuple > >*', u'ns3::split3::DuplicateSet*')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::DuplicateTuple, std::allocator< ns3::split3::DuplicateTuple > >&', u'ns3::split3::DuplicateSet&')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::MprSelectorTuple, std::allocator< ns3::split3::MprSelectorTuple > >', u'ns3::split3::MprSelectorSet')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::MprSelectorTuple, std::allocator< ns3::split3::MprSelectorTuple > >*', u'ns3::split3::MprSelectorSet*')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::MprSelectorTuple, std::allocator< ns3::split3::MprSelectorTuple > >&', u'ns3::split3::MprSelectorSet&')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::TopologyTuple, std::allocator< ns3::split3::TopologyTuple > >', u'ns3::split3::TopologySet')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::TopologyTuple, std::allocator< ns3::split3::TopologyTuple > >*', u'ns3::split3::TopologySet*')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::TopologyTuple, std::allocator< ns3::split3::TopologyTuple > >&', u'ns3::split3::TopologySet&')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::NeighborTuple, std::allocator< ns3::split3::NeighborTuple > >', u'ns3::split3::NeighborSet')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::NeighborTuple, std::allocator< ns3::split3::NeighborTuple > >*', u'ns3::split3::NeighborSet*')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::NeighborTuple, std::allocator< ns3::split3::NeighborTuple > >&', u'ns3::split3::NeighborSet&')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::LinkTuple, std::allocator< ns3::split3::LinkTuple > >', u'ns3::split3::LinkSet')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::LinkTuple, std::allocator< ns3::split3::LinkTuple > >*', u'ns3::split3::LinkSet*')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::LinkTuple, std::allocator< ns3::split3::LinkTuple > >&', u'ns3::split3::LinkSet&')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::MessageHeader, std::allocator< ns3::split3::MessageHeader > >', u'ns3::split3::MessageList')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::MessageHeader, std::allocator< ns3::split3::MessageHeader > >*', u'ns3::split3::MessageList*')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::MessageHeader, std::allocator< ns3::split3::MessageHeader > >&', u'ns3::split3::MessageList&')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::AssociationTuple, std::allocator< ns3::split3::AssociationTuple > >', u'ns3::split3::AssociationSet')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::AssociationTuple, std::allocator< ns3::split3::AssociationTuple > >*', u'ns3::split3::AssociationSet*')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::AssociationTuple, std::allocator< ns3::split3::AssociationTuple > >&', u'ns3::split3::AssociationSet&')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::Association, std::allocator< ns3::split3::Association > >', u'ns3::split3::Associations')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::Association, std::allocator< ns3::split3::Association > >*', u'ns3::split3::Associations*')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::Association, std::allocator< ns3::split3::Association > >&', u'ns3::split3::Associations&')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::IfaceAssocTuple, std::allocator< ns3::split3::IfaceAssocTuple > >', u'ns3::split3::IfaceAssocSet')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::IfaceAssocTuple, std::allocator< ns3::split3::IfaceAssocTuple > >*', u'ns3::split3::IfaceAssocSet*')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::IfaceAssocTuple, std::allocator< ns3::split3::IfaceAssocTuple > >&', u'ns3::split3::IfaceAssocSet&')
    typehandlers.add_type_alias(u'std::set< ns3::Ipv4Address, std::less< ns3::Ipv4Address >, std::allocator< ns3::Ipv4Address > >', u'ns3::split3::MprSet')
    typehandlers.add_type_alias(u'std::set< ns3::Ipv4Address, std::less< ns3::Ipv4Address >, std::allocator< ns3::Ipv4Address > >*', u'ns3::split3::MprSet*')
    typehandlers.add_type_alias(u'std::set< ns3::Ipv4Address, std::less< ns3::Ipv4Address >, std::allocator< ns3::Ipv4Address > >&', u'ns3::split3::MprSet&')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::TwoHopNeighborTuple, std::allocator< ns3::split3::TwoHopNeighborTuple > >', u'ns3::split3::TwoHopNeighborSet')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::TwoHopNeighborTuple, std::allocator< ns3::split3::TwoHopNeighborTuple > >*', u'ns3::split3::TwoHopNeighborSet*')
    typehandlers.add_type_alias(u'std::vector< ns3::split3::TwoHopNeighborTuple, std::allocator< ns3::split3::TwoHopNeighborTuple > >&', u'ns3::split3::TwoHopNeighborSet&')
...
def register_methods(root_module):
    ...
    register_Ns3Split3Helper_methods(root_module, root_module['ns3::Split3Helper'])
    ...
    register_Ns3Split3Association_methods(root_module, root_module['ns3::split3::Association'])
    register_Ns3Split3AssociationTuple_methods(root_module, root_module['ns3::split3::AssociationTuple'])
    register_Ns3Split3DuplicateTuple_methods(root_module, root_module['ns3::split3::DuplicateTuple'])
    register_Ns3Split3IfaceAssocTuple_methods(root_module, root_module['ns3::split3::IfaceAssocTuple'])
    register_Ns3Split3LinkTuple_methods(root_module, root_module['ns3::split3::LinkTuple'])
    register_Ns3Split3MessageHeader_methods(root_module, root_module['ns3::split3::MessageHeader'])
    register_Ns3Split3MessageHeaderHello_methods(root_module, root_module['ns3::split3::MessageHeader::Hello'])
    register_Ns3Split3MessageHeaderHelloLinkMessage_methods(root_module, root_module['ns3::split3::MessageHeader::Hello::LinkMessage'])
    register_Ns3Split3MessageHeaderHna_methods(root_module, root_module['ns3::split3::MessageHeader::Hna'])
    register_Ns3Split3MessageHeaderHnaAssociation_methods(root_module, root_module['ns3::split3::MessageHeader::Hna::Association'])
    register_Ns3Split3MessageHeaderMid_methods(root_module, root_module['ns3::split3::MessageHeader::Mid'])
    register_Ns3Split3MessageHeaderTc_methods(root_module, root_module['ns3::split3::MessageHeader::Tc'])
    register_Ns3Split3MprSelectorTuple_methods(root_module, root_module['ns3::split3::MprSelectorTuple'])
    register_Ns3Split3NeighborTuple_methods(root_module, root_module['ns3::split3::NeighborTuple'])
    register_Ns3Split3Split3State_methods(root_module, root_module['ns3::split3::Split3State'])
    register_Ns3Split3PacketHeader_methods(root_module, root_module['ns3::split3::PacketHeader'])
    register_Ns3Split3RoutingProtocol_methods(root_module, root_module['ns3::split3::RoutingProtocol'])
    register_Ns3Split3RoutingTableEntry_methods(root_module, root_module['ns3::split3::RoutingTableEntry'])
    register_Ns3Split3TopologyTuple_methods(root_module, root_module['ns3::split3::TopologyTuple'])
    register_Ns3Split3TwoHopNeighborTuple_methods(root_module, root_module['ns3::split3::TwoHopNeighborTuple'])
    return
...
def register_Ns3Split3Helper_methods(root_module, cls):
    ## split3-helper.h (module 'split3'): ns3::Split3Helper::Split3Helper() [constructor]
    cls.add_constructor([])
    ## split3-helper.h (module 'split3'): ns3::Split3Helper::Split3Helper(ns3::Split3Helper const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::Split3Helper const &', 'arg0')])
    ## split3-helper.h (module 'split3'): ns3::Split3Helper * ns3::Split3Helper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::Split3Helper *', 
                   [], 
                   is_const=True, is_virtual=True)
    ## split3-helper.h (module 'split3'): void ns3::Split3Helper::ExcludeInterface(ns3::Ptr<ns3::Node> node, uint32_t interface) [member function]
    cls.add_method('ExcludeInterface', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node'), param('uint32_t', 'interface')])
    ## split3-helper.h (module 'split3'): ns3::Ptr<ns3::Ipv4RoutingProtocol> ns3::Split3Helper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::Ipv4RoutingProtocol >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True, is_virtual=True)
    ## split3-helper.h (module 'split3'): void ns3::Split3Helper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    ## split3-helper.h (module 'split3'): int64_t ns3::Split3Helper::AssignStreams(ns3::NodeContainer c, int64_t stream) [member function]
...
def register_Ns3Split3Association_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## split3-repositories.h (module 'split3'): ns3::split3::Association::Association() [constructor]
    cls.add_constructor([])
    ## split3-repositories.h (module 'split3'): ns3::split3::Association::Association(ns3::split3::Association const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::Association const &', 'arg0')])
    ## split3-repositories.h (module 'split3'): ns3::split3::Association::netmask [variable]
    cls.add_instance_attribute('netmask', 'ns3::Ipv4Mask', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::Association::networkAddr [variable]
    cls.add_instance_attribute('networkAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3Split3AssociationTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## split3-repositories.h (module 'split3'): ns3::split3::AssociationTuple::AssociationTuple() [constructor]
    cls.add_constructor([])
    ## split3-repositories.h (module 'split3'): ns3::split3::AssociationTuple::AssociationTuple(ns3::split3::AssociationTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::AssociationTuple const &', 'arg0')])
    ## split3-repositories.h (module 'split3'): ns3::split3::AssociationTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::AssociationTuple::gatewayAddr [variable]
    cls.add_instance_attribute('gatewayAddr', 'ns3::Ipv4Address', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::AssociationTuple::netmask [variable]
    cls.add_instance_attribute('netmask', 'ns3::Ipv4Mask', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::AssociationTuple::networkAddr [variable]
    cls.add_instance_attribute('networkAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3Split3DuplicateTuple_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## split3-repositories.h (module 'split3'): ns3::split3::DuplicateTuple::DuplicateTuple() [constructor]
    cls.add_constructor([])
    ## split3-repositories.h (module 'split3'): ns3::split3::DuplicateTuple::DuplicateTuple(ns3::split3::DuplicateTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::DuplicateTuple const &', 'arg0')])
    ## split3-repositories.h (module 'split3'): ns3::split3::DuplicateTuple::address [variable]
    cls.add_instance_attribute('address', 'ns3::Ipv4Address', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::DuplicateTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::DuplicateTuple::ifaceList [variable]
    cls.add_instance_attribute('ifaceList', 'std::vector< ns3::Ipv4Address >', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::DuplicateTuple::retransmitted [variable]
    cls.add_instance_attribute('retransmitted', 'bool', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::DuplicateTuple::sequenceNumber [variable]
    cls.add_instance_attribute('sequenceNumber', 'uint16_t', is_const=False)
    return

def register_Ns3Split3IfaceAssocTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## split3-repositories.h (module 'split3'): ns3::split3::IfaceAssocTuple::IfaceAssocTuple() [constructor]
    cls.add_constructor([])
    ## split3-repositories.h (module 'split3'): ns3::split3::IfaceAssocTuple::IfaceAssocTuple(ns3::split3::IfaceAssocTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::IfaceAssocTuple const &', 'arg0')])
    ## split3-repositories.h (module 'split3'): ns3::split3::IfaceAssocTuple::ifaceAddr [variable]
    cls.add_instance_attribute('ifaceAddr', 'ns3::Ipv4Address', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::IfaceAssocTuple::mainAddr [variable]
    cls.add_instance_attribute('mainAddr', 'ns3::Ipv4Address', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::IfaceAssocTuple::time [variable]
    cls.add_instance_attribute('time', 'ns3::Time', is_const=False)
    return

def register_Ns3Split3LinkTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## split3-repositories.h (module 'split3'): ns3::split3::LinkTuple::LinkTuple() [constructor]
    cls.add_constructor([])
    ## split3-repositories.h (module 'split3'): ns3::split3::LinkTuple::LinkTuple(ns3::split3::LinkTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::LinkTuple const &', 'arg0')])
    ## split3-repositories.h (module 'split3'): ns3::split3::LinkTuple::asymTime [variable]
    cls.add_instance_attribute('asymTime', 'ns3::Time', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::LinkTuple::localIfaceAddr [variable]
    cls.add_instance_attribute('localIfaceAddr', 'ns3::Ipv4Address', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::LinkTuple::neighborIfaceAddr [variable]
    cls.add_instance_attribute('neighborIfaceAddr', 'ns3::Ipv4Address', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::LinkTuple::symTime [variable]
    cls.add_instance_attribute('symTime', 'ns3::Time', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::LinkTuple::time [variable]
    cls.add_instance_attribute('time', 'ns3::Time', is_const=False)
    return

def register_Ns3Split3MessageHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::MessageHeader(ns3::split3::MessageHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::MessageHeader const &', 'arg0')])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::MessageHeader() [constructor]
    cls.add_constructor([])
    ## split3-header.h (module 'split3'): uint32_t ns3::split3::MessageHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hello & ns3::split3::MessageHeader::GetHello() [member function]
    cls.add_method('GetHello', 
                   'ns3::split3::MessageHeader::Hello &', 
                   [])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hello const & ns3::split3::MessageHeader::GetHello() const [member function]
    cls.add_method('GetHello', 
                   'ns3::split3::MessageHeader::Hello const &', 
                   [], 
                   is_const=True)
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hna & ns3::split3::MessageHeader::GetHna() [member function]
    cls.add_method('GetHna', 
                   'ns3::split3::MessageHeader::Hna &', 
                   [])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hna const & ns3::split3::MessageHeader::GetHna() const [member function]
    cls.add_method('GetHna', 
                   'ns3::split3::MessageHeader::Hna const &', 
                   [], 
                   is_const=True)
    ## split3-header.h (module 'split3'): uint8_t ns3::split3::MessageHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## split3-header.h (module 'split3'): ns3::TypeId ns3::split3::MessageHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## split3-header.h (module 'split3'): uint16_t ns3::split3::MessageHeader::GetMessageSequenceNumber() const [member function]
    cls.add_method('GetMessageSequenceNumber', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::MessageType ns3::split3::MessageHeader::GetMessageType() const [member function]
    cls.add_method('GetMessageType', 
                   'ns3::split3::MessageHeader::MessageType', 
                   [], 
                   is_const=True)
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Mid & ns3::split3::MessageHeader::GetMid() [member function]
    cls.add_method('GetMid', 
                   'ns3::split3::MessageHeader::Mid &', 
                   [])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Mid const & ns3::split3::MessageHeader::GetMid() const [member function]
    cls.add_method('GetMid', 
                   'ns3::split3::MessageHeader::Mid const &', 
                   [], 
                   is_const=True)
    ## split3-header.h (module 'split3'): ns3::Ipv4Address ns3::split3::MessageHeader::GetOriginatorAddress() const [member function]
    cls.add_method('GetOriginatorAddress', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## split3-header.h (module 'split3'): uint32_t ns3::split3::MessageHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Tc & ns3::split3::MessageHeader::GetTc() [member function]
    cls.add_method('GetTc', 
                   'ns3::split3::MessageHeader::Tc &', 
                   [])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Tc const & ns3::split3::MessageHeader::GetTc() const [member function]
    cls.add_method('GetTc', 
                   'ns3::split3::MessageHeader::Tc const &', 
                   [], 
                   is_const=True)
    ## split3-header.h (module 'split3'): uint8_t ns3::split3::MessageHeader::GetTimeToLive() const [member function]
    cls.add_method('GetTimeToLive', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## split3-header.h (module 'split3'): static ns3::TypeId ns3::split3::MessageHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## split3-header.h (module 'split3'): ns3::Time ns3::split3::MessageHeader::GetVTime() const [member function]
    cls.add_method('GetVTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## split3-header.h (module 'split3'): void ns3::split3::MessageHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## split3-header.h (module 'split3'): void ns3::split3::MessageHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## split3-header.h (module 'split3'): void ns3::split3::MessageHeader::SetHopCount(uint8_t hopCount) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint8_t', 'hopCount')])
    ## split3-header.h (module 'split3'): void ns3::split3::MessageHeader::SetMessageSequenceNumber(uint16_t messageSequenceNumber) [member function]
    cls.add_method('SetMessageSequenceNumber', 
                   'void', 
                   [param('uint16_t', 'messageSequenceNumber')])
    ## split3-header.h (module 'split3'): void ns3::split3::MessageHeader::SetMessageType(ns3::split3::MessageHeader::MessageType messageType) [member function]
    cls.add_method('SetMessageType', 
                   'void', 
                   [param('ns3::split3::MessageHeader::MessageType', 'messageType')])
    ## split3-header.h (module 'split3'): void ns3::split3::MessageHeader::SetOriginatorAddress(ns3::Ipv4Address originatorAddress) [member function]
    cls.add_method('SetOriginatorAddress', 
                   'void', 
                   [param('ns3::Ipv4Address', 'originatorAddress')])
    ## split3-header.h (module 'split3'): void ns3::split3::MessageHeader::SetTimeToLive(uint8_t timeToLive) [member function]
    cls.add_method('SetTimeToLive', 
                   'void', 
                   [param('uint8_t', 'timeToLive')])
    ## split3-header.h (module 'split3'): void ns3::split3::MessageHeader::SetVTime(ns3::Time time) [member function]
    cls.add_method('SetVTime', 
                   'void', 
                   [param('ns3::Time', 'time')])
    return

def register_Ns3Split3MessageHeaderHello_methods(root_module, cls):
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hello::Hello() [constructor]
    cls.add_constructor([])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hello::Hello(ns3::split3::MessageHeader::Hello const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::MessageHeader::Hello const &', 'arg0')])
    ## split3-header.h (module 'split3'): uint32_t ns3::split3::MessageHeader::Hello::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## split3-header.h (module 'split3'): ns3::Time ns3::split3::MessageHeader::Hello::GetHTime() const [member function]
    cls.add_method('GetHTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## split3-header.h (module 'split3'): uint32_t ns3::split3::MessageHeader::Hello::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## split3-header.h (module 'split3'): void ns3::split3::MessageHeader::Hello::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## split3-header.h (module 'split3'): void ns3::split3::MessageHeader::Hello::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## split3-header.h (module 'split3'): void ns3::split3::MessageHeader::Hello::SetHTime(ns3::Time time) [member function]
    cls.add_method('SetHTime', 
                   'void', 
                   [param('ns3::Time', 'time')])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hello::hTime [variable]
    cls.add_instance_attribute('hTime', 'uint8_t', is_const=False)
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hello::linkMessages [variable]
    cls.add_instance_attribute('linkMessages', 'std::vector< ns3::split3::MessageHeader::Hello::LinkMessage >', is_const=False)
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hello::willingness [variable]
    cls.add_instance_attribute('willingness', 'uint8_t', is_const=False)
    return

def register_Ns3Split3MessageHeaderHelloLinkMessage_methods(root_module, cls):
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hello::LinkMessage::LinkMessage() [constructor]
    cls.add_constructor([])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hello::LinkMessage::LinkMessage(ns3::split3::MessageHeader::Hello::LinkMessage const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::MessageHeader::Hello::LinkMessage const &', 'arg0')])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hello::LinkMessage::linkCode [variable]
    cls.add_instance_attribute('linkCode', 'uint8_t', is_const=False)
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hello::LinkMessage::neighborInterfaceAddresses [variable]
    cls.add_instance_attribute('neighborInterfaceAddresses', 'std::vector< ns3::Ipv4Address >', is_const=False)
    return

def register_Ns3Split3MessageHeaderHna_methods(root_module, cls):
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hna::Hna() [constructor]
    cls.add_constructor([])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hna::Hna(ns3::split3::MessageHeader::Hna const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::MessageHeader::Hna const &', 'arg0')])
    ## split3-header.h (module 'split3'): uint32_t ns3::split3::MessageHeader::Hna::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## split3-header.h (module 'split3'): uint32_t ns3::split3::MessageHeader::Hna::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## split3-header.h (module 'split3'): void ns3::split3::MessageHeader::Hna::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## split3-header.h (module 'split3'): void ns3::split3::MessageHeader::Hna::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hna::associations [variable]
    cls.add_instance_attribute('associations', 'std::vector< ns3::split3::MessageHeader::Hna::Association >', is_const=False)
    return

def register_Ns3Split3MessageHeaderHnaAssociation_methods(root_module, cls):
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hna::Association::Association() [constructor]
    cls.add_constructor([])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hna::Association::Association(ns3::split3::MessageHeader::Hna::Association const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::MessageHeader::Hna::Association const &', 'arg0')])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hna::Association::address [variable]
    cls.add_instance_attribute('address', 'ns3::Ipv4Address', is_const=False)
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Hna::Association::mask [variable]
    cls.add_instance_attribute('mask', 'ns3::Ipv4Mask', is_const=False)
    return

def register_Ns3Split3MessageHeaderMid_methods(root_module, cls):
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Mid::Mid() [constructor]
    cls.add_constructor([])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Mid::Mid(ns3::split3::MessageHeader::Mid const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::MessageHeader::Mid const &', 'arg0')])
    ## split3-header.h (module 'split3'): uint32_t ns3::split3::MessageHeader::Mid::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## split3-header.h (module 'split3'): uint32_t ns3::split3::MessageHeader::Mid::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## split3-header.h (module 'split3'): void ns3::split3::MessageHeader::Mid::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## split3-header.h (module 'split3'): void ns3::split3::MessageHeader::Mid::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Mid::interfaceAddresses [variable]
    cls.add_instance_attribute('interfaceAddresses', 'std::vector< ns3::Ipv4Address >', is_const=False)
    return

def register_Ns3Split3MessageHeaderTc_methods(root_module, cls):
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Tc::Tc() [constructor]
    cls.add_constructor([])
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Tc::Tc(ns3::split3::MessageHeader::Tc const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::MessageHeader::Tc const &', 'arg0')])
    ## split3-header.h (module 'split3'): uint32_t ns3::split3::MessageHeader::Tc::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## split3-header.h (module 'split3'): uint32_t ns3::split3::MessageHeader::Tc::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## split3-header.h (module 'split3'): void ns3::split3::MessageHeader::Tc::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## split3-header.h (module 'split3'): void ns3::split3::MessageHeader::Tc::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Tc::ansn [variable]
    cls.add_instance_attribute('ansn', 'uint16_t', is_const=False)
    ## split3-header.h (module 'split3'): ns3::split3::MessageHeader::Tc::neighborAddresses [variable]
    cls.add_instance_attribute('neighborAddresses', 'std::vector< ns3::Ipv4Address >', is_const=False)
    return

def register_Ns3Split3MprSelectorTuple_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## split3-repositories.h (module 'split3'): ns3::split3::MprSelectorTuple::MprSelectorTuple() [constructor]
    cls.add_constructor([])
    ## split3-repositories.h (module 'split3'): ns3::split3::MprSelectorTuple::MprSelectorTuple(ns3::split3::MprSelectorTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::MprSelectorTuple const &', 'arg0')])
    ## split3-repositories.h (module 'split3'): ns3::split3::MprSelectorTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::MprSelectorTuple::mainAddr [variable]
    cls.add_instance_attribute('mainAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3Split3NeighborTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## split3-repositories.h (module 'split3'): ns3::split3::NeighborTuple::NeighborTuple() [constructor]
    cls.add_constructor([])
    ## split3-repositories.h (module 'split3'): ns3::split3::NeighborTuple::NeighborTuple(ns3::split3::NeighborTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::NeighborTuple const &', 'arg0')])
    ## split3-repositories.h (module 'split3'): ns3::split3::NeighborTuple::neighborMainAddr [variable]
    cls.add_instance_attribute('neighborMainAddr', 'ns3::Ipv4Address', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::NeighborTuple::status [variable]
    cls.add_instance_attribute('status', 'ns3::split3::NeighborTuple::Status', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::NeighborTuple::willingness [variable]
    cls.add_instance_attribute('willingness', 'uint8_t', is_const=False)
    return

def register_Ns3Split3Split3State_methods(root_module, cls):
    ## split3-state.h (module 'split3'): ns3::split3::Split3State::Split3State(ns3::split3::Split3State const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::Split3State const &', 'arg0')])
    ## split3-state.h (module 'split3'): ns3::split3::Split3State::Split3State() [constructor]
    cls.add_constructor([])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::EraseAssociation(ns3::split3::Association const & tuple) [member function]
    cls.add_method('EraseAssociation', 
                   'void', 
                   [param('ns3::split3::Association const &', 'tuple')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::EraseAssociationTuple(ns3::split3::AssociationTuple const & tuple) [member function]
    cls.add_method('EraseAssociationTuple', 
                   'void', 
                   [param('ns3::split3::AssociationTuple const &', 'tuple')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::EraseDuplicateTuple(ns3::split3::DuplicateTuple const & tuple) [member function]
    cls.add_method('EraseDuplicateTuple', 
                   'void', 
                   [param('ns3::split3::DuplicateTuple const &', 'tuple')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::EraseIfaceAssocTuple(ns3::split3::IfaceAssocTuple const & tuple) [member function]
    cls.add_method('EraseIfaceAssocTuple', 
                   'void', 
                   [param('ns3::split3::IfaceAssocTuple const &', 'tuple')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::EraseLinkTuple(ns3::split3::LinkTuple const & tuple) [member function]
    cls.add_method('EraseLinkTuple', 
                   'void', 
                   [param('ns3::split3::LinkTuple const &', 'tuple')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::EraseMprSelectorTuple(ns3::split3::MprSelectorTuple const & tuple) [member function]
    cls.add_method('EraseMprSelectorTuple', 
                   'void', 
                   [param('ns3::split3::MprSelectorTuple const &', 'tuple')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::EraseMprSelectorTuples(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('EraseMprSelectorTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::EraseNeighborTuple(ns3::split3::NeighborTuple const & neighborTuple) [member function]
    cls.add_method('EraseNeighborTuple', 
                   'void', 
                   [param('ns3::split3::NeighborTuple const &', 'neighborTuple')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::EraseNeighborTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('EraseNeighborTuple', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::EraseOlderTopologyTuples(ns3::Ipv4Address const & lastAddr, uint16_t ansn) [member function]
    cls.add_method('EraseOlderTopologyTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'lastAddr'), param('uint16_t', 'ansn')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::EraseTopologyTuple(ns3::split3::TopologyTuple const & tuple) [member function]
    cls.add_method('EraseTopologyTuple', 
                   'void', 
                   [param('ns3::split3::TopologyTuple const &', 'tuple')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::EraseTwoHopNeighborTuple(ns3::split3::TwoHopNeighborTuple const & tuple) [member function]
    cls.add_method('EraseTwoHopNeighborTuple', 
                   'void', 
                   [param('ns3::split3::TwoHopNeighborTuple const &', 'tuple')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::EraseTwoHopNeighborTuples(ns3::Ipv4Address const & neighbor) [member function]
    cls.add_method('EraseTwoHopNeighborTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'neighbor')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::EraseTwoHopNeighborTuples(ns3::Ipv4Address const & neighbor, ns3::Ipv4Address const & twoHopNeighbor) [member function]
    cls.add_method('EraseTwoHopNeighborTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'neighbor'), param('ns3::Ipv4Address const &', 'twoHopNeighbor')])
    ## split3-state.h (module 'split3'): ns3::split3::AssociationTuple * ns3::split3::Split3State::FindAssociationTuple(ns3::Ipv4Address const & gatewayAddr, ns3::Ipv4Address const & networkAddr, ns3::Ipv4Mask const & netmask) [member function]
    cls.add_method('FindAssociationTuple', 
                   'ns3::split3::AssociationTuple *', 
                   [param('ns3::Ipv4Address const &', 'gatewayAddr'), param('ns3::Ipv4Address const &', 'networkAddr'), param('ns3::Ipv4Mask const &', 'netmask')])
    ## split3-state.h (module 'split3'): ns3::split3::DuplicateTuple * ns3::split3::Split3State::FindDuplicateTuple(ns3::Ipv4Address const & address, uint16_t sequenceNumber) [member function]
    cls.add_method('FindDuplicateTuple', 
                   'ns3::split3::DuplicateTuple *', 
                   [param('ns3::Ipv4Address const &', 'address'), param('uint16_t', 'sequenceNumber')])
    ## split3-state.h (module 'split3'): ns3::split3::IfaceAssocTuple * ns3::split3::Split3State::FindIfaceAssocTuple(ns3::Ipv4Address const & ifaceAddr) [member function]
    cls.add_method('FindIfaceAssocTuple', 
                   'ns3::split3::IfaceAssocTuple *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr')])
    ## split3-state.h (module 'split3'): ns3::split3::IfaceAssocTuple const * ns3::split3::Split3State::FindIfaceAssocTuple(ns3::Ipv4Address const & ifaceAddr) const [member function]
    cls.add_method('FindIfaceAssocTuple', 
                   'ns3::split3::IfaceAssocTuple const *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr')], 
                   is_const=True)
    ## split3-state.h (module 'split3'): ns3::split3::LinkTuple * ns3::split3::Split3State::FindLinkTuple(ns3::Ipv4Address const & ifaceAddr) [member function]
    cls.add_method('FindLinkTuple', 
                   'ns3::split3::LinkTuple *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr')])
    ## split3-state.h (module 'split3'): bool ns3::split3::Split3State::FindMprAddress(ns3::Ipv4Address const & address) [member function]
    cls.add_method('FindMprAddress', 
                   'bool', 
                   [param('ns3::Ipv4Address const &', 'address')])
    ## split3-state.h (module 'split3'): ns3::split3::MprSelectorTuple * ns3::split3::Split3State::FindMprSelectorTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('FindMprSelectorTuple', 
                   'ns3::split3::MprSelectorTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## split3-state.h (module 'split3'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::split3::Split3State::FindNeighborInterfaces(ns3::Ipv4Address const & neighborMainAddr) const [member function]
    cls.add_method('FindNeighborInterfaces', 
                   'std::vector< ns3::Ipv4Address >', 
                   [param('ns3::Ipv4Address const &', 'neighborMainAddr')], 
                   is_const=True)
    ## split3-state.h (module 'split3'): ns3::split3::NeighborTuple * ns3::split3::Split3State::FindNeighborTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('FindNeighborTuple', 
                   'ns3::split3::NeighborTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## split3-state.h (module 'split3'): ns3::split3::NeighborTuple * ns3::split3::Split3State::FindNeighborTuple(ns3::Ipv4Address const & mainAddr, uint8_t willingness) [member function]
    cls.add_method('FindNeighborTuple', 
                   'ns3::split3::NeighborTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr'), param('uint8_t', 'willingness')])
    ## split3-state.h (module 'split3'): ns3::split3::TopologyTuple * ns3::split3::Split3State::FindNewerTopologyTuple(ns3::Ipv4Address const & lastAddr, uint16_t ansn) [member function]
    cls.add_method('FindNewerTopologyTuple', 
                   'ns3::split3::TopologyTuple *', 
                   [param('ns3::Ipv4Address const &', 'lastAddr'), param('uint16_t', 'ansn')])
    ## split3-state.h (module 'split3'): ns3::split3::LinkTuple * ns3::split3::Split3State::FindSymLinkTuple(ns3::Ipv4Address const & ifaceAddr, ns3::Time time) [member function]
    cls.add_method('FindSymLinkTuple', 
                   'ns3::split3::LinkTuple *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr'), param('ns3::Time', 'time')])
    ## split3-state.h (module 'split3'): ns3::split3::NeighborTuple const * ns3::split3::Split3State::FindSymNeighborTuple(ns3::Ipv4Address const & mainAddr) const [member function]
    cls.add_method('FindSymNeighborTuple', 
                   'ns3::split3::NeighborTuple const *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')], 
                   is_const=True)
    ## split3-state.h (module 'split3'): ns3::split3::TopologyTuple * ns3::split3::Split3State::FindTopologyTuple(ns3::Ipv4Address const & destAddr, ns3::Ipv4Address const & lastAddr) [member function]
    cls.add_method('FindTopologyTuple', 
                   'ns3::split3::TopologyTuple *', 
                   [param('ns3::Ipv4Address const &', 'destAddr'), param('ns3::Ipv4Address const &', 'lastAddr')])
    ## split3-state.h (module 'split3'): ns3::split3::TwoHopNeighborTuple * ns3::split3::Split3State::FindTwoHopNeighborTuple(ns3::Ipv4Address const & neighbor, ns3::Ipv4Address const & twoHopNeighbor) [member function]
    cls.add_method('FindTwoHopNeighborTuple', 
                   'ns3::split3::TwoHopNeighborTuple *', 
                   [param('ns3::Ipv4Address const &', 'neighbor'), param('ns3::Ipv4Address const &', 'twoHopNeighbor')])
    ## split3-state.h (module 'split3'): ns3::split3::AssociationSet const & ns3::split3::Split3State::GetAssociationSet() const [member function]
    cls.add_method('GetAssociationSet', 
                   'ns3::split3::AssociationSet const &', 
                   [], 
                   is_const=True)
    ## split3-state.h (module 'split3'): ns3::split3::Associations const & ns3::split3::Split3State::GetAssociations() const [member function]
    cls.add_method('GetAssociations', 
                   'ns3::split3::Associations const &', 
                   [], 
                   is_const=True)
    ## split3-state.h (module 'split3'): ns3::split3::IfaceAssocSet const & ns3::split3::Split3State::GetIfaceAssocSet() const [member function]
    cls.add_method('GetIfaceAssocSet', 
                   'ns3::split3::IfaceAssocSet const &', 
                   [], 
                   is_const=True)
    ## split3-state.h (module 'split3'): ns3::split3::IfaceAssocSet & ns3::split3::Split3State::GetIfaceAssocSetMutable() [member function]
    cls.add_method('GetIfaceAssocSetMutable', 
                   'ns3::split3::IfaceAssocSet &', 
                   [])
    ## split3-state.h (module 'split3'): ns3::split3::LinkSet const & ns3::split3::Split3State::GetLinks() const [member function]
    cls.add_method('GetLinks', 
                   'ns3::split3::LinkSet const &', 
                   [], 
                   is_const=True)
    ## split3-state.h (module 'split3'): ns3::split3::MprSelectorSet const & ns3::split3::Split3State::GetMprSelectors() const [member function]
    cls.add_method('GetMprSelectors', 
                   'ns3::split3::MprSelectorSet const &', 
                   [], 
                   is_const=True)
    ## split3-state.h (module 'split3'): ns3::split3::MprSet ns3::split3::Split3State::GetMprSet() const [member function]
    cls.add_method('GetMprSet', 
                   'ns3::split3::MprSet', 
                   [], 
                   is_const=True)
    ## split3-state.h (module 'split3'): ns3::split3::NeighborSet const & ns3::split3::Split3State::GetNeighbors() const [member function]
    cls.add_method('GetNeighbors', 
                   'ns3::split3::NeighborSet const &', 
                   [], 
                   is_const=True)
    ## split3-state.h (module 'split3'): ns3::split3::NeighborSet & ns3::split3::Split3State::GetNeighbors() [member function]
    cls.add_method('GetNeighbors', 
                   'ns3::split3::NeighborSet &', 
                   [])
    ## split3-state.h (module 'split3'): ns3::split3::TopologySet const & ns3::split3::Split3State::GetTopologySet() const [member function]
    cls.add_method('GetTopologySet', 
                   'ns3::split3::TopologySet const &', 
                   [], 
                   is_const=True)
    ## split3-state.h (module 'split3'): ns3::split3::TwoHopNeighborSet const & ns3::split3::Split3State::GetTwoHopNeighbors() const [member function]
    cls.add_method('GetTwoHopNeighbors', 
                   'ns3::split3::TwoHopNeighborSet const &', 
                   [], 
                   is_const=True)
    ## split3-state.h (module 'split3'): ns3::split3::TwoHopNeighborSet & ns3::split3::Split3State::GetTwoHopNeighbors() [member function]
    cls.add_method('GetTwoHopNeighbors', 
                   'ns3::split3::TwoHopNeighborSet &', 
                   [])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::InsertAssociation(ns3::split3::Association const & tuple) [member function]
    cls.add_method('InsertAssociation', 
                   'void', 
                   [param('ns3::split3::Association const &', 'tuple')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::InsertAssociationTuple(ns3::split3::AssociationTuple const & tuple) [member function]
    cls.add_method('InsertAssociationTuple', 
                   'void', 
                   [param('ns3::split3::AssociationTuple const &', 'tuple')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::InsertDuplicateTuple(ns3::split3::DuplicateTuple const & tuple) [member function]
    cls.add_method('InsertDuplicateTuple', 
                   'void', 
                   [param('ns3::split3::DuplicateTuple const &', 'tuple')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::InsertIfaceAssocTuple(ns3::split3::IfaceAssocTuple const & tuple) [member function]
    cls.add_method('InsertIfaceAssocTuple', 
                   'void', 
                   [param('ns3::split3::IfaceAssocTuple const &', 'tuple')])
    ## split3-state.h (module 'split3'): ns3::split3::LinkTuple & ns3::split3::Split3State::InsertLinkTuple(ns3::split3::LinkTuple const & tuple) [member function]
    cls.add_method('InsertLinkTuple', 
                   'ns3::split3::LinkTuple &', 
                   [param('ns3::split3::LinkTuple const &', 'tuple')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::InsertMprSelectorTuple(ns3::split3::MprSelectorTuple const & tuple) [member function]
    cls.add_method('InsertMprSelectorTuple', 
                   'void', 
                   [param('ns3::split3::MprSelectorTuple const &', 'tuple')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::InsertNeighborTuple(ns3::split3::NeighborTuple const & tuple) [member function]
    cls.add_method('InsertNeighborTuple', 
                   'void', 
                   [param('ns3::split3::NeighborTuple const &', 'tuple')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::InsertTopologyTuple(ns3::split3::TopologyTuple const & tuple) [member function]
    cls.add_method('InsertTopologyTuple', 
                   'void', 
                   [param('ns3::split3::TopologyTuple const &', 'tuple')])
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::InsertTwoHopNeighborTuple(ns3::split3::TwoHopNeighborTuple const & tuple) [member function]
    cls.add_method('InsertTwoHopNeighborTuple', 
                   'void', 
                   [param('ns3::split3::TwoHopNeighborTuple const &', 'tuple')])
    ## split3-state.h (module 'split3'): std::string ns3::split3::Split3State::PrintMprSelectorSet() const [member function]
    cls.add_method('PrintMprSelectorSet', 
                   'std::string', 
                   [], 
                   is_const=True)
    ## split3-state.h (module 'split3'): void ns3::split3::Split3State::SetMprSet(ns3::split3::MprSet mprSet) [member function]
    cls.add_method('SetMprSet', 
                   'void', 
                   [param('ns3::split3::MprSet', 'mprSet')])
    return

def register_Ns3Split3PacketHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## split3-header.h (module 'split3'): ns3::split3::PacketHeader::PacketHeader(ns3::split3::PacketHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::PacketHeader const &', 'arg0')])
    ## split3-header.h (module 'split3'): ns3::split3::PacketHeader::PacketHeader() [constructor]
    cls.add_constructor([])
    ## split3-header.h (module 'split3'): uint32_t ns3::split3::PacketHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## split3-header.h (module 'split3'): ns3::TypeId ns3::split3::PacketHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## split3-header.h (module 'split3'): uint16_t ns3::split3::PacketHeader::GetPacketLength() const [member function]
    cls.add_method('GetPacketLength', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## split3-header.h (module 'split3'): uint16_t ns3::split3::PacketHeader::GetPacketSequenceNumber() const [member function]
    cls.add_method('GetPacketSequenceNumber', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## split3-header.h (module 'split3'): uint32_t ns3::split3::PacketHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## split3-header.h (module 'split3'): static ns3::TypeId ns3::split3::PacketHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## split3-header.h (module 'split3'): void ns3::split3::PacketHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## split3-header.h (module 'split3'): void ns3::split3::PacketHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## split3-header.h (module 'split3'): void ns3::split3::PacketHeader::SetPacketLength(uint16_t length) [member function]
    cls.add_method('SetPacketLength', 
                   'void', 
                   [param('uint16_t', 'length')])
    ## split3-header.h (module 'split3'): void ns3::split3::PacketHeader::SetPacketSequenceNumber(uint16_t seqnum) [member function]
    cls.add_method('SetPacketSequenceNumber', 
                   'void', 
                   [param('uint16_t', 'seqnum')])
    return

def register_Ns3Split3RoutingProtocol_methods(root_module, cls):
    ## split3-routing-protocol.h (module 'split3'): ns3::split3::RoutingProtocol::RoutingProtocol(ns3::split3::RoutingProtocol const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::RoutingProtocol const &', 'arg0')])
    ## split3-routing-protocol.h (module 'split3'): ns3::split3::RoutingProtocol::RoutingProtocol() [constructor]
    cls.add_constructor([])
    ## split3-routing-protocol.h (module 'split3'): void ns3::split3::RoutingProtocol::AddHostNetworkAssociation(ns3::Ipv4Address networkAddr, ns3::Ipv4Mask netmask) [member function]
    cls.add_method('AddHostNetworkAssociation', 
                   'void', 
                   [param('ns3::Ipv4Address', 'networkAddr'), param('ns3::Ipv4Mask', 'netmask')])
    ## split3-routing-protocol.h (module 'split3'): int64_t ns3::split3::RoutingProtocol::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## split3-routing-protocol.h (module 'split3'): void ns3::split3::RoutingProtocol::Dump() [member function]
    cls.add_method('Dump', 
                   'void', 
                   [])
    ## split3-routing-protocol.h (module 'split3'): std::set<unsigned int, std::less<unsigned int>, std::allocator<unsigned int> > ns3::split3::RoutingProtocol::GetInterfaceExclusions() const [member function]
    cls.add_method('GetInterfaceExclusions', 
                   'std::set< unsigned int >', 
                   [], 
                   is_const=True)
    ## split3-routing-protocol.h (module 'split3'): ns3::Ptr<const ns3::Ipv4StaticRouting> ns3::split3::RoutingProtocol::GetRoutingTableAssociation() const [member function]
    cls.add_method('GetRoutingTableAssociation', 
                   'ns3::Ptr< ns3::Ipv4StaticRouting const >', 
                   [], 
                   is_const=True)
    ## split3-routing-protocol.h (module 'split3'): std::vector<ns3::split3::RoutingTableEntry,std::allocator<ns3::split3::RoutingTableEntry> > ns3::split3::RoutingProtocol::GetRoutingTableEntries() const [member function]
    cls.add_method('GetRoutingTableEntries', 
                   'std::vector< ns3::split3::RoutingTableEntry >', 
                   [], 
                   is_const=True)
    ## split3-routing-protocol.h (module 'split3'): static ns3::TypeId ns3::split3::RoutingProtocol::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## split3-routing-protocol.h (module 'split3'): void ns3::split3::RoutingProtocol::RemoveHostNetworkAssociation(ns3::Ipv4Address networkAddr, ns3::Ipv4Mask netmask) [member function]
    cls.add_method('RemoveHostNetworkAssociation', 
                   'void', 
                   [param('ns3::Ipv4Address', 'networkAddr'), param('ns3::Ipv4Mask', 'netmask')])
    ## split3-routing-protocol.h (module 'split3'): void ns3::split3::RoutingProtocol::SetInterfaceExclusions(std::set<unsigned int, std::less<unsigned int>, std::allocator<unsigned int> > exceptions) [member function]
    cls.add_method('SetInterfaceExclusions', 
                   'void', 
                   [param('std::set< unsigned int >', 'exceptions')])
    ## split3-routing-protocol.h (module 'split3'): void ns3::split3::RoutingProtocol::SetMainInterface(uint32_t interface) [member function]
    cls.add_method('SetMainInterface', 
                   'void', 
                   [param('uint32_t', 'interface')])
    ## split3-routing-protocol.h (module 'split3'): void ns3::split3::RoutingProtocol::SetRoutingTableAssociation(ns3::Ptr<ns3::Ipv4StaticRouting> routingTable) [member function]
    cls.add_method('SetRoutingTableAssociation', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4StaticRouting >', 'routingTable')])
    ## split3-routing-protocol.h (module 'split3'): void ns3::split3::RoutingProtocol::DoInitialize() [member function]
    cls.add_method('DoInitialize', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
    ## split3-routing-protocol.h (module 'split3'): void ns3::split3::RoutingProtocol::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='private', is_virtual=True)
    ## split3-routing-protocol.h (module 'split3'): void ns3::split3::RoutingProtocol::NotifyAddAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyAddAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   visibility='private', is_virtual=True)
    ## split3-routing-protocol.h (module 'split3'): void ns3::split3::RoutingProtocol::NotifyInterfaceDown(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceDown', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   visibility='private', is_virtual=True)
    ## split3-routing-protocol.h (module 'split3'): void ns3::split3::RoutingProtocol::NotifyInterfaceUp(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceUp', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   visibility='private', is_virtual=True)
    ## split3-routing-protocol.h (module 'split3'): void ns3::split3::RoutingProtocol::NotifyRemoveAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyRemoveAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   visibility='private', is_virtual=True)
    ## split3-routing-protocol.h (module 'split3'): void ns3::split3::RoutingProtocol::PrintRoutingTable(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('PrintRoutingTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True, visibility='private', is_virtual=True)
    ## split3-routing-protocol.h (module 'split3'): bool ns3::split3::RoutingProtocol::RouteInput(ns3::Ptr<const ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<const ns3::NetDevice> idev, ns3::Callback<void,ns3::Ptr<ns3::Ipv4Route>,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> ucb, ns3::Callback<void,ns3::Ptr<ns3::Ipv4MulticastRoute>,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> mcb, ns3::Callback<void,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,unsigned int,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> lcb, ns3::Callback<void,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::Socket::SocketErrno,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> ecb) [member function]
    cls.add_method('RouteInput', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice const >', 'idev'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4Route >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ucb'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4MulticastRoute >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'mcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'lcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ecb')], 
                   visibility='private', is_virtual=True)
    ## split3-routing-protocol.h (module 'split3'): ns3::Ptr<ns3::Ipv4Route> ns3::split3::RoutingProtocol::RouteOutput(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::NetDevice> oif, ns3::Socket::SocketErrno & sockerr) [member function]
    cls.add_method('RouteOutput', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice >', 'oif'), param('ns3::Socket::SocketErrno &', 'sockerr')], 
                   visibility='private', is_virtual=True)
    ## split3-routing-protocol.h (module 'split3'): void ns3::split3::RoutingProtocol::SetIpv4(ns3::Ptr<ns3::Ipv4> ipv4) [member function]
    cls.add_method('SetIpv4', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4 >', 'ipv4')], 
                   visibility='private', is_virtual=True)
...
def register_Ns3Split3RoutingTableEntry_methods(root_module, cls):
    ## split3-routing-protocol.h (module 'split3'): ns3::split3::RoutingTableEntry::RoutingTableEntry(ns3::split3::RoutingTableEntry const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::RoutingTableEntry const &', 'arg0')])
    ## split3-routing-protocol.h (module 'split3'): ns3::split3::RoutingTableEntry::RoutingTableEntry() [constructor]
    cls.add_constructor([])
    ## split3-routing-protocol.h (module 'split3'): ns3::split3::RoutingTableEntry::destAddr [variable]
    cls.add_instance_attribute('destAddr', 'ns3::Ipv4Address', is_const=False)
    ## split3-routing-protocol.h (module 'split3'): ns3::split3::RoutingTableEntry::distance [variable]
    cls.add_instance_attribute('distance', 'uint32_t', is_const=False)
    ## split3-routing-protocol.h (module 'split3'): ns3::split3::RoutingTableEntry::interface [variable]
    cls.add_instance_attribute('interface', 'uint32_t', is_const=False)
    ## split3-routing-protocol.h (module 'split3'): ns3::split3::RoutingTableEntry::nextAddr [variable]
    cls.add_instance_attribute('nextAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3Split3TopologyTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## split3-repositories.h (module 'split3'): ns3::split3::TopologyTuple::TopologyTuple() [constructor]
    cls.add_constructor([])
    ## split3-repositories.h (module 'split3'): ns3::split3::TopologyTuple::TopologyTuple(ns3::split3::TopologyTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::TopologyTuple const &', 'arg0')])
    ## split3-repositories.h (module 'split3'): ns3::split3::TopologyTuple::destAddr [variable]
    cls.add_instance_attribute('destAddr', 'ns3::Ipv4Address', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::TopologyTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::TopologyTuple::lastAddr [variable]
    cls.add_instance_attribute('lastAddr', 'ns3::Ipv4Address', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::TopologyTuple::sequenceNumber [variable]
    cls.add_instance_attribute('sequenceNumber', 'uint16_t', is_const=False)
    return

def register_Ns3Split3TwoHopNeighborTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## split3-repositories.h (module 'split3'): ns3::split3::TwoHopNeighborTuple::TwoHopNeighborTuple() [constructor]
    cls.add_constructor([])
    ## split3-repositories.h (module 'split3'): ns3::split3::TwoHopNeighborTuple::TwoHopNeighborTuple(ns3::split3::TwoHopNeighborTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::split3::TwoHopNeighborTuple const &', 'arg0')])
    ## split3-repositories.h (module 'split3'): ns3::split3::TwoHopNeighborTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::TwoHopNeighborTuple::neighborMainAddr [variable]
    cls.add_instance_attribute('neighborMainAddr', 'ns3::Ipv4Address', is_const=False)
    ## split3-repositories.h (module 'split3'): ns3::split3::TwoHopNeighborTuple::twoHopNeighborAddr [variable]
...
def register_functions(root_module):
    ...
    register_functions_ns3_split3(module.get_submodule('split3'), root_module)
    return
...
def register_functions_ns3_split3(module, root_module):
    ## split3-header.h (module 'split3'): extern double ns3::split3::EmfToSeconds(uint8_t emf) [free function]
    module.add_function('EmfToSeconds', 
                        'double', 
                        [param('uint8_t', 'emf')])
    ## split3-header.h (module 'split3'): extern uint8_t ns3::split3::SecondsToEmf(double seconds) [free function]
