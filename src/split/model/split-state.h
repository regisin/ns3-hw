...
/// \brief	This header file declares and defines internal state of an SPLIT node.

#ifndef SPLIT_STATE_H
#define SPLIT_STATE_H
...
/// \ingroup split
/// This class encapsulates all data structures needed for maintaining internal state of an SPLIT node.
class SplitState
{
  //  friend class Split;
...
protected:
  ...
  double m_histSize;                      //!< The size of the history list
  History m_hist;                         //!< The node's local History that will be used while calculating the metric of a link
...
public:
  ...
  ////////////////////////////////////////////////////////////////////////////// split stuff
  /**
   * Inserts a HistTuple at the end of the line.
   * \param tuple The tuple to insert.
   * \returns True if an older entry was dropped, false otherwise.
   */
  bool InsertHistTuple(const HistTuple& tuple);

  /**
   * Returns the percentage of the history that was sent to a certain neighbor.
   * \param neighborAddr The neighbor main address
   * \returns A double in the interval [0.0,1.0] representing the percentage.
   */
  double GetHistPercentage(const Ipv4Address& neighborAddr);

  /**
   * Updates the value of the history list, default is 100 entries.
   * \param size New size of the history list, must be greater or equal than 1.
   * \returns True if successfully updated, false otherwise.
   */
  bool SetHistSize(double size);

  /**
   * Returns the maximum size the history can have.
   * \returns A double representing the size.
   */
  double GetHistSize();
  /*
   * Prints all entries in the history stack
   */
