...
#ifndef SPLIT2_HEADER_H
#define SPLIT2_HEADER_H
 ...
 * \ingroup split2
 *
 * The basic layout of any packet in SPLIT2 is as follows (omitting IP and
 * UDP headers):
  \verbatim
    0                   1                   2                   3
