...
///
/// \brief Here are defined all data structures needed by an SPLIT2 node.
///

#ifndef SPLIT2_REPOSITORIES_H
#define SPLIT2_REPOSITORIES_H
...
}  // namespace ns3, split2

#endif /* SPLIT2_REPOSITORIES_H */
