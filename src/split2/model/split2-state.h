...
/// \brief	This header file declares and defines internal state of an SPLIT2 node.

#ifndef SPLIT2_STATE_H
#define SPLIT2_STATE_H
...
/// \ingroup split2
/// This class encapsulates all data structures needed for maintaining internal state of an SPLIT2 node.
class Split2State
{
  //  friend class Split2;
...
public:
   ...
   */
  bool InsertHistTuple(const HistTuple& tuple, uint32_t histSize);
   ...
   */
  void UpdateHistStack(uint32_t size);
