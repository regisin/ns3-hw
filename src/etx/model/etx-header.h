...
#define ETX_UNDEFINED_LQ 0         // -------------------- NEW
#define ETX_MAXIMUM_METRIC 65535   // -------------------- NEW
...
double EmfToEtxVal (uint8_t etxFormat);
 // ------------- END

/**
 * \ingroup etx
 *
 * The basic layout of any packet in ETX is as follows (omitting IP and
 * UDP headers):
  \verbatim
    0                   1                   2                   3
