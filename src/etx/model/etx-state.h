...
/// \brief	This header file declares and defines internal state of an etx node.
...
/// \ingroup etx
/// This class encapsulates all data structures needed for maintaining internal state of an etx node.
class EtxState
{
  //  friend class Etx;
