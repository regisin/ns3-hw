...
MprSelectorTuple*
EtxState::FindMprSelectorTuple (Ipv4Address const &mainAddr)
{
...
void
EtxState::EraseMprSelectorTuple (const MprSelectorTuple &tuple)
{
  for (MprSelectorSet::iterator it = m_mprSelectorSet.begin ();
       it != m_mprSelectorSet.end (); it++)
    {
...
void
EtxState::EraseMprSelectorTuples (const Ipv4Address &mainAddr)
{
  for (MprSelectorSet::iterator it = m_mprSelectorSet.begin ();
...
void
EtxState::InsertMprSelectorTuple (MprSelectorTuple const &tuple)
{
  m_mprSelectorSet.push_back (tuple);
}

std::string
EtxState::PrintMprSelectorSet () const
{
...
NeighborTuple*
EtxState::FindNeighborTuple (Ipv4Address const &mainAddr)
{
...
const NeighborTuple*
EtxState::FindSymNeighborTuple (Ipv4Address const &mainAddr) const
{
...
NeighborTuple*
EtxState::FindNeighborTuple (Ipv4Address const &mainAddr, uint8_t willingness)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
void
EtxState::EraseNeighborTuple (const NeighborTuple &tuple)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
void
EtxState::EraseNeighborTuple (const Ipv4Address &mainAddr)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
void
EtxState::InsertNeighborTuple (NeighborTuple const &tuple)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
TwoHopNeighborTuple*
EtxState::FindTwoHopNeighborTuple (Ipv4Address const &neighborMainAddr,
...
void
EtxState::EraseTwoHopNeighborTuple (const TwoHopNeighborTuple &tuple)
{
  for (TwoHopNeighborSet::iterator it = m_twoHopNeighborSet.begin ();
       it != m_twoHopNeighborSet.end (); it++)
    {
...
void
EtxState::EraseTwoHopNeighborTuples (const Ipv4Address &neighborMainAddr,
...
void
EtxState::InsertTwoHopNeighborTuple (TwoHopNeighborTuple const &tuple)
{
...
bool
EtxState::FindMprAddress (Ipv4Address const &addr)
{
...
void
EtxState::SetMprSet (MprSet mprSet)
{
  m_mprSet = mprSet;
}
MprSet
EtxState::GetMprSet () const
{
  return m_mprSet;
}
...
DuplicateTuple*
EtxState::FindDuplicateTuple (Ipv4Address const &addr, uint16_t sequenceNumber)
{
...
void
EtxState::EraseDuplicateTuple (const DuplicateTuple &tuple)
{
  for (DuplicateSet::iterator it = m_duplicateSet.begin ();
       it != m_duplicateSet.end (); it++)
    {
...
void
EtxState::InsertDuplicateTuple (DuplicateTuple const &tuple)
{
...
LinkTuple*
EtxState::FindLinkTuple (Ipv4Address const & ifaceAddr)
{
...
LinkTuple*
EtxState::FindSymLinkTuple (Ipv4Address const &ifaceAddr, Time now)
{
  for (LinkSet::iterator it = m_linkSet.begin ();
       it != m_linkSet.end (); it++)
    {
...
void
EtxState::EraseLinkTuple (const LinkTuple &tuple)
{
  for (LinkSet::iterator it = m_linkSet.begin ();
       it != m_linkSet.end (); it++)
    {
...
LinkTuple&
EtxState::InsertLinkTuple (LinkTuple const &tuple)
{
...
TopologyTuple*
EtxState::FindTopologyTuple (Ipv4Address const &destAddr,
...
TopologyTuple*
EtxState::FindNewerTopologyTuple (Ipv4Address const & lastAddr, uint16_t ansn)
{
  for (TopologySet::iterator it = m_topologySet.begin ();
       it != m_topologySet.end (); it++)
    {
...
void
EtxState::EraseTopologyTuple (const TopologyTuple &tuple)
{
  for (TopologySet::iterator it = m_topologySet.begin ();
       it != m_topologySet.end (); it++)
    {
...
void
EtxState::EraseOlderTopologyTuples (const Ipv4Address &lastAddr, uint16_t ansn)
{
  for (TopologySet::iterator it = m_topologySet.begin ();
...
void
EtxState::InsertTopologyTuple (TopologyTuple const &tuple)
{
...
IfaceAssocTuple*
EtxState::FindIfaceAssocTuple (Ipv4Address const &ifaceAddr)
{
...
EtxState::FindIfaceAssocTuple (Ipv4Address const &ifaceAddr) const
{
...
void
EtxState::EraseIfaceAssocTuple (const IfaceAssocTuple &tuple)
{
  for (IfaceAssocSet::iterator it = m_ifaceAssocSet.begin ();
       it != m_ifaceAssocSet.end (); it++)
    {
...
void
EtxState::InsertIfaceAssocTuple (const IfaceAssocTuple &tuple)
{
  m_ifaceAssocSet.push_back (tuple);
}

std::vector<Ipv4Address>
EtxState::FindNeighborInterfaces (const Ipv4Address &neighborMainAddr) const
{
...
AssociationTuple*
EtxState::FindAssociationTuple (const Ipv4Address &gatewayAddr, const Ipv4Address &networkAddr, const Ipv4Mask &netmask)
{
...
void
EtxState::EraseAssociationTuple (const AssociationTuple &tuple)
{
  for (AssociationSet::iterator it = m_associationSet.begin ();
       it != m_associationSet.end (); it++)
    {
...
void
EtxState::InsertAssociationTuple (const AssociationTuple &tuple)
{
  m_associationSet.push_back (tuple);
}

void
EtxState::EraseAssociation (const Association &tuple)
{
...
void
EtxState::InsertAssociation (const Association &tuple)
{
