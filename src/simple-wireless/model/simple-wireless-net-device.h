...
//  
  ...
  void SetEnergyDevice (Ptr<SimpleWirelessEnergyModel> e);
  Ptr<SimpleWirelessEnergyModel> GetEnergyDevice (void) const;
  void SetCurrentDown();
  void SetCurrentUp();
...
private:
   ...
   * \see class CallBackTraceSource
   */
  TracedCallback<Ptr<const Packet> > m_TxBeginTrace;
   ...
   * \see class CallBackTraceSource
   */
  TracedCallback<Ptr<const Packet> > m_QueueLatencyTrace;
  ...
  Ptr<SimpleWirelessEnergyModel> m_energyDevice;
};
