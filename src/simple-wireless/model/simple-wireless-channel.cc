...
SimpleWirelessChannel::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::SimpleWirelessChannel")
    ...
    .AddAttribute ("ChannelWidth",
                   ...
                   MakeUintegerAccessor (&SimpleWirelessChannel::m_channelWidth),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("ChannelFreq",
                   "The channel carrier frequency in Hz.",
                   UintegerValue (2450000000),
                   MakeUintegerAccessor (&SimpleWirelessChannel::m_channelFreq),
                   MakeUintegerChecker<uint32_t> ())
    ;
  return tid;
}
...
SimpleWirelessChannel::SimpleWirelessChannel ()
{
	...
	m_fixedContentionRange = 0;
        m_channelWidth = 20; // default channel width is 20 MHz
}
...
uint32_t
SimpleWirelessChannel::GetChannelWidth()
{
    return m_channelWidth;
}

void
SimpleWirelessChannel::SetChannelWidth(uint32_t w)
{
    NS_ASSERT(w > 0);
    m_channelWidth = w;
}
...
uint32_t
SimpleWirelessChannel::GetChannelFreq()
{
    return m_channelWidth;
}

void
SimpleWirelessChannel::SetChannelFreq(uint32_t w)
{
    NS_ASSERT(w > 0);
    m_channelWidth = w;
}
...
double
SimpleWirelessChannel::GetMaxRange()
{
    return m_range;
}
