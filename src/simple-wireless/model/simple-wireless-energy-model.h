...
#ifndef SIMPLE_WIRELESS_ENERGY_MODEL_H
#define SIMPLE_WIRELESS_ENERGY_MODEL_H
 ...
 *
 */
class SimpleWirelessEnergyModel : public DeviceEnergyModel
{
public:
  static TypeId GetTypeId (void);
  SimpleWirelessEnergyModel ();
  virtual ~SimpleWirelessEnergyModel ();
